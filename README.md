...
修改词根数据后运行 `pnpm audit:word-roots`，确保同一卡片内没有重复例词、重复释义或重复小测试选项；如果题目考词根，问题文案使用「xxx 这个词根的意思是什么？」；如果题目考单词，问题文案使用「单词 xxx 的意思是什么？」或保持目标单词能在 `examples` 中找到。
